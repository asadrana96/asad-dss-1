                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" placeholder="Branch Manager's Name" id="demo-hor-inputemail"
                                        class="form-control" name="branch_manager_name" {{old('branch_manager_name')}}>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label text-primary text-bold"
                                ...
                                <div class="col-sm-5">
                                    <input type="text" placeholder="Branch Contact No" id="demo-hor-inputemail"
                                        class="form-control" name="branch_contact_no" {{old('branch_contact_no')}}>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label text-primary text-bold"
                                ...
                                <div class="col-sm-5">
                                    <input type="text" placeholder="Branch IT Support Name" id="demo-hor-inputemail"
                                        class="form-control" name="branch_it_support_name"
                                        {{old('branch_it_support_name')}}>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label text-primary text-bold"
                                ...
                                <div class="col-sm-5">
                                    <input type="text" placeholder="Branch IT Support No" id="demo-hor-inputemail"
                                        class="form-control" name="branch_it_support_no"
                                        {{old('branch_it_support_no')}}>
                                </div>
                            </div>
                        </div>
