                        ...
                        <form class="form-horizontal" method="POST" action="{{url('devices/' . $devices->id)}}">
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="col-sm-5">
                                        <select id="branchName" class="form-control" name="branch_id">
                                            @foreach($branches as $branch)
                                                <option value="{{$branch->id}}" {{ $devices->branch_id == $branch->id ? 'selected' : '' }}>{{$branch->branch_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input required type="text" placeholder="Deive Name" id="demo-hor-inputemail" class="form-control" name="device_name" {{old('device_name')}} value="{{$devices->device_name}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label text-primary text-bold" for="demo-hor-inputemail">Device No</label>
                                    <div class="col-sm-5">
                                        <input  type="text" placeholder="Deive No" id="demo-hor-inputemail" class="form-control" name="device_no" {{old('device_no')}} value="{{$devices->device_no}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label text-primary text-bold" for="demo-hor-inputemail">Device IP</label>
                                    <div class="col-sm-5">
                                        <input required type="text" placeholder="Device IP" id="demo-hor-inputemail" class="form-control" name="device_ip" {{old('device_ip')}} value="{{$devices->device_ip}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label text-primary text-bold" for="demo-hor-inputemail">Device Model</label>
                                    <div class="col-sm-5">
                                        <input  type="text" placeholder="Device Model" id="demo-hor-inputemail" class="form-control" name="device_model" {{old('device_model')}} value="{{$devices->device_model}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label text-primary text-bold" for="demo-hor-inputemail">Device Screen Height</label>
                                    <div class="col-sm-5">
                                        <input  type="text" placeholder="Device Screen Height" id="demo-hor-inputemail" class="form-control" name="device_screen_height" {{old('device_screen_height')}} value="{{$devices->device_screen_height}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label text-primary text-bold" for="demo-hor-inputemail">Device Screen Width</label>
                                    <div class="col-sm-5">
                                        <input  type="text" placeholder="Device Screen Width" id="demo-hor-inputemail" class="form-control" name="device_screen_width" {{old('device_screen_width')}} value="{{$devices->device_screen_width}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label text-primary text-bold" for="demo-hor-inputemail">Device Storage Memory</label>
                                    <div class="col-sm-5">
                                        <input  type="text" placeholder="Device Storage Memory" id="demo-hor-inputemail" class="form-control" name="device_storage_memory" {{old('device_storage_memory')}} value="{{$devices->device_storage_memory}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label text-primary text-bold" for="demo-hor-inputemail">Screen Resolution</label>
                                    <div class="col-sm-5">
                                        <input  type="text" placeholder="Screen Resolution" id="demo-hor-inputemail" class="form-control" name="screen_resolution" {{old('screen_resolution')}} value="{{$devices->screen_resolution}}">
                                    </div>
                                </div>
                            </div>
