...
<script src="{{asset('admin-assets/plugins/datatables/extensions/Responsive/js/dataTables.responsive.min.js')}}">
</script>
...
<script src="{{asset('admin-assets/js/demo/form-file-upload.js')}}"></script>
